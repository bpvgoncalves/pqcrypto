...
[![Codecov test coverage](https://codecov.io/gh/bpvgoncalves/pqcrypto/branch/main/graph/badge.svg)](https://app.codecov.io/gh/bpvgoncalves/pqcrypto?branch=main)
<!-- badges: end -->
...
You can install the development version of pqcrypto from [GitHub](https://github.com/) with:
