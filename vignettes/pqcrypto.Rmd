...
The National Institute of Standards and Technology (NIST) has been actively involved in the research and standardization of post-quantum cryptography (PQC) algorithms to address these threats. NIST initiated a public competition known as the "NIST Post-Quantum Cryptography Standardization" to identify and evaluate new cryptographic algorithms that can resist attacks from both classical and quantum computers. This competition is still ongoing and as of the time of this writing (01/Sep/2023), NIST is requesting comments^[See https://csrc.nist.gov/news/2023/three-draft-fips-for-post-quantum-cryptography] on 3 drafts for proposed "Federal Information Processing Standards" (FIPS) covering key encapsulation (FIPS-203) and digital signatures (FIPS-204 and FIPS-205), each covering parameters with different security strenght categories.
