...
cpp11::list cpp_keygen_kyber512() {
  ...
  cpp11::writable::raws ret_sk(pqcrystals_kyber512_SECRETKEYBYTES);
  cpp11::writable::raws ret_pk(pqcrystals_kyber512_PUBLICKEYBYTES);
...
cpp11::list cpp_keygen_kyber768() {
  ...
  cpp11::writable::raws ret_sk(pqcrystals_kyber768_SECRETKEYBYTES);
  cpp11::writable::raws ret_pk(pqcrystals_kyber768_PUBLICKEYBYTES);
...
cpp11::list cpp_keygen_kyber1024() {
  ...
  cpp11::writable::raws ret_sk(pqcrystals_kyber1024_SECRETKEYBYTES);
  cpp11::writable::raws ret_pk(pqcrystals_kyber1024_PUBLICKEYBYTES);
