test_that("Sphincs+ signature (shake, 128, small)", {
  ...
  expect_equal(attr(sig, "sign_algorithm"), "1.3.6.1.4.1.54392.5.1859.1.3.2")
...
test_that("Sphincs+ signature (shake, 128, fast)", {
  ...
  sig <- sign_sphincs(key$private, "Hello world!!")
  expect_true(inherits(sig, "pqcrypto_signature"))
  expect_equal(attr(sig, "sign_algorithm"), "1.3.6.1.4.1.54392.5.1859.1.3.4")
...
test_that("Sphincs+ signature (shake, 192, small)", {
  ...
  sig <- sign_sphincs(key$private, "Hello world!!")
  expect_true(inherits(sig, "pqcrypto_signature"))
  expect_equal(attr(sig, "sign_algorithm"), "1.3.6.1.4.1.54392.5.1859.1.3.6")
...
test_that("Sphincs+ signature (shake, 192, fast)", {
  ...
  sig <- sign_sphincs(key$private, "Hello world!!")
  expect_true(inherits(sig, "pqcrypto_signature"))
  expect_equal(attr(sig, "sign_algorithm"), "1.3.6.1.4.1.54392.5.1859.1.3.8")
...
test_that("Sphincs+ signature (shake, 256, small)", {
  ...
  sig <- sign_sphincs(key$private, "Hello world!!")
  expect_true(inherits(sig, "pqcrypto_signature"))
  expect_equal(attr(sig, "sign_algorithm"), "1.3.6.1.4.1.54392.5.1859.1.3.10")
...
test_that("Sphincs+ signature (shake, 256, fast)", {
  ...
  sig <- sign_sphincs(key$private, "Hello world!!")
  expect_true(inherits(sig, "pqcrypto_signature"))
  expect_equal(attr(sig, "sign_algorithm"), "1.3.6.1.4.1.54392.5.1859.1.3.12")
...
test_that("Sphincs+ signature (sha2, 128, small)", {
  ...
  sig <- sign_sphincs(key$private, "Hello world!!")
  expect_true(inherits(sig, "pqcrypto_signature"))
  expect_equal(attr(sig, "sign_algorithm"), "1.3.6.1.4.1.54392.5.1859.1.3.1")
  expect_equal(length(sig), 7856)
...
test_that("Sphincs+ signature (sha2, 128, fast)", {
  ...
  sig <- sign_sphincs(key$private, "Hello world!!")
  expect_true(inherits(sig, "pqcrypto_signature"))
  expect_equal(attr(sig, "sign_algorithm"), "1.3.6.1.4.1.54392.5.1859.1.3.3")
  expect_equal(length(sig), 17088)
...
test_that("Sphincs+ signature (sha2, 192, small)", {
  ...
  sig <- sign_sphincs(key$private, "Hello world!!")
  expect_true(inherits(sig, "pqcrypto_signature"))
  expect_equal(attr(sig, "sign_algorithm"), "1.3.6.1.4.1.54392.5.1859.1.3.5")
  expect_equal(length(sig), 16224)
...
test_that("Sphincs+ signature (sha2, 192, fast)", {
  ...
  sig <- sign_sphincs(key$private, "Hello world!!")
  expect_true(inherits(sig, "pqcrypto_signature"))
  expect_equal(attr(sig, "sign_algorithm"), "1.3.6.1.4.1.54392.5.1859.1.3.7")
  expect_equal(length(sig), 35664)
...
test_that("Sphincs+ signature (sha2, 256, small)", {
  ...
  sig <- sign_sphincs(key$private, "Hello world!!")
  expect_true(inherits(sig, "pqcrypto_signature"))
  expect_equal(attr(sig, "sign_algorithm"), "1.3.6.1.4.1.54392.5.1859.1.3.9")
  expect_equal(length(sig), 29792)
...
test_that("Sphincs+ signature (sha2, 256, fast)", {
  ...
  sig <- sign_sphincs(key$private, "Hello world!!")
  expect_true(inherits(sig, "pqcrypto_signature"))
  expect_equal(attr(sig, "sign_algorithm"), "1.3.6.1.4.1.54392.5.1859.1.3.11")
  expect_equal(length(sig), 49856)
