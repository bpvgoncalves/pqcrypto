test_that("ML-DSA-44 digital signature", {
  ...
  expect_equal(sig$signer_infos$signature_algorithm, "2.16.840.1.101.3.4.3.17")
...
test_that("ML-DSA-65 digital signature", {
  ...
  sig <- sign_ml_dsa(key$private, "Hello world!!")
  expect_true(inherits(sig, "pqcrypto_cms_id_signed_data"))
  expect_equal(sig$signer_infos$signature_algorithm, "2.16.840.1.101.3.4.3.18")
...
test_that("ML-DSA-87 digital signature", {
  ...
  sig <- sign_ml_dsa(key$private, "Hello world!!")
  expect_true(inherits(sig, "pqcrypto_cms_id_signed_data"))
  expect_equal(sig$signer_infos$signature_algorithm, "2.16.840.1.101.3.4.3.19")
...
test_that("Dilithium digital signature fails on wrong parameters", {
  ...
  attr(small_key, "algorithm") <- "2.16.840.1.101.3.4.3.17"
